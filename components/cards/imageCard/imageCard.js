...
const ImageCard = ({data})=>{
    ...
    return(
        <div className={`body-wrapper ${styles.wrapper}`} style={{flexDirection:data.direction[0]}}>
                ...
                {size.width > 550 ? <Image objectFit='cotain' src={data.img} width={550} height={380} alt='visa' />:
                <Image objectFit='cotain' src={data.img} width={size.width} height={250} alt='visa' />
                }
